...
## Why?
Most news (whether they are fake or not) websites, for instance the supermajority of sites scraped from the [GDELT](https://www.gdeltproject.org/data.html) dataset, use **hyphenated transliterated titles** as the URLs of their articles.
